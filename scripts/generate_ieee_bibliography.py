...
SUPPLEMENTAL_PUBLICATIONS = [
    ...
    (2026, "G. Sabiron, S. Jay, L. Agelas, E. Speirs, G. Feng, and S. Bussod, “From Road Traffic to Virtual Air Quality Sensors: An Integrated Mesoscopic Modelling Framework,” in Proceedings of the 26th Transport and Pollution (TaP) Conference, 2026. [Online]. Available: https://publications.jrc.ec.europa.eu/repository/bitstream/JRC146901/JRC146901_01.pdf"),
    (2026, "G. Sabiron and G. Feng, “Vehicle fleet modelling methodology and prospective impact on local air quality: A practical application in France,” Transport Research Arena 2026, 2026. [Online]. Available: https://traconference.eu/new/agenda?date=2026-05-22"),
    ...
    (2024, "C. V. Nguyen, L. Soulhac, P. Charvolin, and G. Sabiron, “Assessment of urban air quality using the SIRANE dispersion model and a new method for estimating traffic emissions,” 22nd International Conference on Harmonisation within Atmospheric Dispersion Modelling for Regulatory Purposes (HARMO22), 2024. [Online]. Available: https://harmo.org/conference.php?id=22"),
]


PATENTS = [
    (2026, "L. Agelas and G. Sabiron", "Procédé de détermination de la dispersion atmosphérique d’au moins un polluant", "FR3167737A1", "published application", "https://patents.google.com/patent/FR3167737A1/fr"),
    (2026, "G. De Nunzio, A. Hammoumi, B. Othman, and G. Sabiron", "Procédé de détermination d’un débit de véhicules sur un réseau routier", "FR3160497B1", "granted patent", "https://patents.google.com/patent/FR3160497B1/fr"),
    (2025, "S. Bussod, G. De Nunzio, B. Othman, and G. Sabiron", "Procédé de détermination d’une quantité d’au moins un polluant émis par un ensemble de véhicules", "EP4575943A1", "published application", "https://patents.google.com/patent/EP4575943A1/fr"),
    ...
    (2024, "G. De Nunzio, F. J. Gonzalez de Cossio Echeverria, and G. Sabiron", "Procédé de détermination d’au moins un attribut du trafic routier pour un réseau de transport", "FR3145802A1", "published application", "https://patents.google.com/patent/FR3145802A1/fr"),
    ...
    (2023, "G. De Nunzio, M. Laraki, B. Othman, and G. Sabiron", "Procédé de détermination d’un débit de véhicules sur un réseau routier à partir de données de géolocalisation", "EP4261802A1", "published application", "https://patents.google.com/patent/EP4261802A1/fr"),
    (2023, "R. Goussault, F. Guillemin, and G. Sabiron", "Procédé de détermination des composantes de la vitesse du vent au moyen d’un capteur de télédétection par laser et d’une cohérence temporelle", "EP4172648A1", "published application", "https://patents.google.com/patent/EP4172648A1/fr"),
    (2022, "M. Al-Amir, D. Collet, D. Di Domenico, and G. Sabiron", "Procédé et système de contrôle d’une grandeur d’une éolienne par choix du contrôleur par apprentissage automatique", "EP3956559A1", "published application", "https://patents.google.com/patent/EP3956559A1/fr"),
    ...
    (2021, "B. Bayon, J. Chauvin, R. Goussault, F. Guillemin, and G. Sabiron", "Procédé de détermination des composantes de la vitesse du vent au moyen d’un capteur de télédétection par laser", "CA3177085A1", "published application", "https://patents.google.com/patent/CA3177085A1/fr"),
