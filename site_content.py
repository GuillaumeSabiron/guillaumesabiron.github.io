...
PLANETAIR_WORKFLOW = [
    {"id":"data", "accent":"cyan", "icon":"car", "en":{"title":"Mobility & fleet data","items":["Trips","GPS traces","Fleet composition","Road networks","Territorial scenarios"]}, "fr":{"title":"Données mobilité et flotte","items":["Trajets","Traces GPS","Composition des flottes","Réseaux routiers","Scénarios territoriaux"]}},
    {"id":"traffic", "accent":"blue", "icon":"traffic", "en":{"title":"Traffic animation model","items":["Traffic flows","Vehicle speeds","Congestion","Driving behaviour","Temporal dynamics"]}, "fr":{"title":"Modèle d’animation du trafic","items":["Flux de trafic","Vitesses des véhicules","Congestion","Comportement de conduite","Dynamiques temporelles"]}},
    {"id":"emissions", "accent":"amber", "icon":"chart", "en":{"title":"Emissions & noise models","items":["CO₂","NOx","Particulate matter","Energy use","Noise · uncertainty"]}, "fr":{"title":"Modèles d’émissions et de bruit","items":["CO₂","NOx","Particules","Consommation d’énergie","Bruit · incertitude"]}},
    {"id":"dispersion", "accent":"teal", "icon":"wind", "en":{"title":"Atmospheric dispersion","items":["Weather","Urban morphology","Pollutant propagation","High-resolution concentration fields"]}, "fr":{"title":"Dispersion atmosphérique","items":["Météo","Morphologie urbaine","Propagation des polluants","Champs de concentration haute résolution"]}},
    {"id":"geo", "accent":"green", "icon":"map", "en":{"title":"Geospatial services","items":["Interactive maps","APIs","Environmental indicators","Exposure analysis","Pollution hotspots"]}, "fr":{"title":"Services géospatiaux","items":["Cartes interactives","API","Indicateurs environnementaux","Analyse d’exposition","Hotspots de pollution"]}},
    {"id":"decision", "accent":"violet", "icon":"decision", "en":{"title":"Scenario decision support","items":["Diagnose","Compare","Project","Communicate","Support territorial decisions"]}, "fr":{"title":"Aide à la décision par scénarios","items":["Diagnostiquer","Comparer","Projeter","Communiquer","Éclairer les décisions territoriales"]}},
]

SKILL_AREAS = [
    {"en":"R&D programme and technical leadership","fr":"Pilotage de programmes R&D et leadership technique","expertise":{"en":"Roadmaps, technical prioritisation and functional coordination across 20+ contributors.","fr":"Feuilles de route, priorisation technique et coordination fonctionnelle de plus de 20 contributeurs."},"tools":{"en":"Work packages · milestones · risks · interfaces · reviews · demonstrations","fr":"Lots de travail · jalons · risques · interfaces · revues · démonstrations"},"evidence":{"en":"PLANET’AIR, European and international collaborations.","fr":"PLANET’AIR, collaborations européennes et internationales."}},
    {"en":"Systems engineering and architecture","fr":"Ingénierie système et architecture","expertise":{"en":"Functional and system architecture, constraints, trade-offs, verification and validation.","fr":"Architecture fonctionnelle et système, contraintes, arbitrages, vérification et validation."},"tools":{"en":"Software-in-the-loop simulation · experimental validation · demonstrators","fr":"Simulation software-in-the-loop · validation expérimentale · démonstrateurs"},"evidence":{"en":"PLANET’AIR, Geco Air and autonomous-systems research.","fr":"PLANET’AIR, Geco Air et recherche sur les systèmes autonomes."}},
    {"en":"Modelling, control and autonomous systems","fr":"Modélisation, commande et systèmes autonomes","expertise":{"en":"Dynamic modelling, GNC, robust and predictive control, estimation and optic flow.","fr":"Modélisation dynamique, GNC, commande robuste et prédictive, estimation et flux optique."},"tools":{"en":"MATLAB · Simulink · signal processing · system identification","fr":"MATLAB · Simulink · traitement du signal · identification système"},"evidence":{"en":"PhD research, wind-energy and wave-energy control.","fr":"Doctorat, commande éolienne et énergie houlomotrice."}},
    {"en":"Applied AI, data and software","fr":"IA appliquée, données et logiciel","expertise":{"en":"Applied machine learning, behaviour prediction and physical or hybrid models.","fr":"Apprentissage automatique appliqué, prédiction de comportements et modèles physiques ou hybrides."},"tools":{"en":"Python · Pandas · NumPy · Scikit-learn · REST APIs · MongoDB · PostgreSQL · Git · GitLab · CI/CD · Streamlit · Plotly","fr":"Python · Pandas · NumPy · Scikit-learn · API REST · MongoDB · PostgreSQL · Git · GitLab · CI/CD · Streamlit · Plotly"},"evidence":{"en":"Mobility and emissions modelling, scientific data pipelines.","fr":"Modélisation mobilité et émissions, pipelines de données scientifiques."}},
    {"en":"Geospatial, mobility and environmental intelligence","fr":"Géospatial, mobilité et intelligence environnementale","expertise":{"en":"GIS/GPS, traffic and fleet modelling, emissions, air quality, dispersion and exposure.","fr":"SIG/GPS, modélisation du trafic et des flottes, émissions, qualité de l’air, dispersion et exposition."},"tools":{"en":"Road networks · territorial scenarios · geospatial APIs · decision-support maps","fr":"Réseaux routiers · scénarios territoriaux · API géospatiales · cartes d’aide à la décision"},"evidence":{"en":"PLANET’AIR and Geco Air.","fr":"PLANET’AIR et Geco Air."}},
    {"en":"Scientific and digital products","fr":"Produits scientifiques et numériques","expertise":{"en":"Scientific and product roadmaps, requirements, integration and prototype-to-product transition.","fr":"Feuilles de route scientifiques et produit, exigences, intégration et passage du prototype au produit."},"tools":{"en":"Data platforms · decision support · API-based services · deployment","fr":"Plateformes data · aide à la décision · services fondés sur des API · déploiement"},"evidence":{"en":"PLANET’AIR and Geco Air.","fr":"PLANET’AIR et Geco Air."}},
    {"en":"Stakeholder and international collaboration","fr":"Parties prenantes et collaboration internationale","expertise":{"en":"Needs analysis, workshops, structured recommendations and scientific communication.","fr":"Analyse des besoins, ateliers, recommandations structurées et communication scientifique."},"tools":{"en":"Partner demonstrations · design reviews · professional English · conference presentations","fr":"Démonstrations partenaires · revues de conception · anglais professionnel · présentations en conférence"},"evidence":{"en":"Industrial, institutional and academic partnerships.","fr":"Partenariats industriels, institutionnels et académiques."}},
]
